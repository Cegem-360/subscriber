        ...
        <tbody>
            ...
            <tr>
                <td style="padding:36px 40px 32px;">
                    <span style="display:inline-block;padding:6px 16px;border-radius:20px;border:2px solid #6161ff;background-color:#f0f0ff;font-size:11px;font-weight:700;color:#6161ff;text-transform:uppercase;letter-spacing:2px;">🔒 Jelszó visszaállítás</span>
                    ...
                    <p style="margin:0;font-size:15px;line-height:1.7;color:#1a1a2e;">
                        Jelszó-visszaállítási kérelmet kaptunk a <strong style="color:#0f0f23;">Cégem 360</strong> fiókjához. Az új jelszó beállításához kattintson az alábbi gombra.
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding:0 40px 28px;">
                    <h2 style="margin:0 0 4px;font-size:20px;color:#0f0f23;">Jelszó beállítása</h2>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td valign="middle">
                                                    ...
                                                    <p style="margin:0;font-size:13px;color:#a5b4fc;">Új jelszó megadása</p>
                                                </td>
                                                <td align="right" valign="middle">
                                                    <a href="{{ $resetUrl }}" style="display:inline-block;padding:12px 26px;border-radius:8px;background:linear-gradient(135deg,#6161ff,#ec4899);font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;" target="_blank">Jelszó visszaállítása →</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding:20px 24px;">
                                    ...
                                    <p style="margin:0;font-family:'Courier New',monospace;font-size:12px;color:#6161ff;word-break:break-all;background-color:#ffffff;border:1px solid #e5e7eb;border-radius:6px;padding:8px 12px;">{{ $resetUrl }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>

                    <p style="margin:16px 0 0;font-size:12px;line-height:1.6;color:#6b7280;">Ha nem Ön kérte a jelszó visszaállítását, nincs teendője — a fiókja biztonságban van, és a jelszava változatlan marad.</p>
                </td>
            </tr>
