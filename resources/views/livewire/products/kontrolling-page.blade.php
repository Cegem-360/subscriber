        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-4xl text-center">
                ...
                <p class="mx-auto max-w-3xl text-lg leading-relaxed text-gray-600 sm:text-xl">
                    Lássa át vállalata pénzügyeit egy pillanat alatt. Bevételek, költségek, cash flow,
                    projekt-jövedelmezőség — minden egy dashboardon. Döntsön adatok alapján, ne megérzésből.
                </p>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div class="rounded-2xl border border-emerald-100 bg-linear-to-br from-emerald-50 to-white p-8">
                    ...
                    <p class="text-gray-600">A pénzügy Excelben, az értékesítés másik táblázatban, a projektek
                        harmadikban.</p>
                </div>
                <div class="rounded-2xl border border-emerald-100 bg-linear-to-br from-emerald-50 to-white p-8">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white shadow-sm">
