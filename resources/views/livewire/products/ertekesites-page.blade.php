        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-4xl text-center">
                ...
                <p class="mx-auto max-w-3xl text-lg leading-relaxed text-gray-600 sm:text-xl">
                    A Cégem360 Értékesítés modul végigkíséri az üzleti folyamatot az ajánlatkéréstől a számlázásig,
                    átlátható és nyomon követhető módon.
                </p>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                <div class="rounded-2xl border border-red-100 bg-linear-to-br from-red-50 to-white p-8">
                    ...
                    <p class="text-gray-600">Órákat tölt egy-egy ajánlat összeállításával, ahelyett hogy értékesítene.
                    </p>
                </div>
                <div class="rounded-2xl border border-red-100 bg-linear-to-br from-red-50 to-white p-8">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white shadow-sm">
    ...
    <section class="bg-gray-50 py-16 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto mb-12 max-w-3xl text-center">
                ...
                <p class="mt-4 text-lg text-gray-600">Minden, amire szüksége van az értékesítési folyamatok kezeléséhez.
                </p>
            </div>
            ...
            <div class="grid gap-8 lg:grid-cols-2">
                <div class="rounded-2xl bg-white p-8 shadow-sm">
                    ...
                    <blockquote class="mb-6 text-lg text-gray-700">
                        „Korábban fél napot töltöttem egy-egy ajánlat összeállításával. Most percek alatt kész, és még
                        szebben is néz ki."
                    </blockquote>
                ...
                <div class="rounded-2xl bg-white p-8 shadow-sm">
                    ...
                    <blockquote class="mb-6 text-lg text-gray-700">
                        „A rendelésekről és számlákról azonnali áttekintésem van. Tudom, mi van teljesítve, mi nincs, és
                        mi a kintlévőség."
                    </blockquote>
                    <div class="flex items-center gap-4">
                        <div
