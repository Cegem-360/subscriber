<div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-4xl text-center">
                ...
                <p class="mx-auto max-w-3xl text-lg text-gray-600 leading-relaxed sm:text-xl">
                    Kis- és középvállalkozásként Ön mindent csinál egyszerre: értékesít, szervez, számlázz, és közben még
    ...
    <section class="bg-white py-16 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div class="rounded-2xl border border-indigo-100 bg-linear-to-br from-indigo-50 to-white p-8">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white shadow-sm">
                        <svg class="h-6 w-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                    </div>
                    <p class="text-lg text-gray-700">
            ...
            {{-- Solution box --}}
            <div class="mx-auto mt-12 max-w-4xl rounded-2xl border border-indigo-100 bg-indigo-50 p-8 text-center lg:p-12">
                ...
                <h3 class="mb-4 text-2xl font-semibold text-gray-900">Ha bármelyik ismerős, a Cégem360 megoldást kínál</h3>
            ...
            <div class="grid gap-8 lg:grid-cols-2">
                ...
                <div class="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-shadow hover:shadow-lg">
                    <div class="mb-4 flex items-center gap-4">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900">Értékesítés — Minden ajánlat nyomon követve</h3>
                    </div>
                    <p class="mb-4 text-gray-600">
    ...
    <section class="bg-white py-16 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto mb-12 max-w-3xl text-center">
                <h2 class="text-3xl font-semibold text-gray-900 sm:text-4xl">Miért választják a KKV-k a Cégem360-at?</h2>
            </div>

            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-gray-100 bg-white p-6 text-center shadow-sm transition-shadow hover:shadow-lg">
                    <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-indigo-100 text-indigo-600">
                ...
                <div class="rounded-2xl border border-gray-100 bg-white p-6 text-center shadow-sm transition-shadow hover:shadow-lg">
                    ...
                    <p class="text-gray-600">14 napos ingyenes próbaidőszak, bankkártya nélkül.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-indigo-600 py-16 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-4 max-w-xl text-lg text-indigo-100">
                14 napos ingyenes próbaidőszak, teljes funkcionalitással. Nincs bankkártya, nincs elköteleződés. Csak
                eredmények.
            </p>
            <div class="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
