        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="rounded-xl bg-gray-50 p-6">
                    ...
                    <p class="text-sm text-gray-600">Az Ön munkafolyamataihoz tervezett képernyők és dashboardok — nem
                        általános sablonok.</p>
                </div>
                ...
                <div class="rounded-xl bg-gray-50 p-6">
                    ...
                    <p class="text-sm text-gray-600">Összekapcsoljuk a meglévő rendszereivel: ERP, számlázó, webshop, HR
                        — bármi.</p>
                </div>
                ...
                <div class="rounded-xl bg-gray-50 p-6">
                    ...
                    <p class="text-sm text-gray-600">Egyedi workflow-k és triggerek, amelyek automatizálják az ismétlődő
                        feladatokat.</p>
                </div>
                ...
                <div class="rounded-xl bg-gray-50 p-6">
                    ...
                    <p class="text-sm text-gray-600">Pontosan azokat az adatokat látja, amelyekre szüksége van — a
                        saját KPI-jaival.</p>
                </div>
                ...
                <div class="rounded-xl bg-gray-50 p-6">
                    ...
                    <p class="text-sm text-gray-600">Személyes kapcsolattartó, aki ismeri az Ön rendszerét és üzletét.
                    </p>
                </div>
                ...
                <div class="rounded-xl bg-gray-50 p-6">
                    ...
                    <p class="text-sm text-gray-600">Garantált rendelkezésre állás és gyorsabb reakcióidő kritikus
                        problémáknál.</p>
                </div>
            </div>
        </div>
            ...
            <div class="relative mt-16">
                ...
                <div class="grid gap-8 lg:grid-cols-4">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Megismerjük a folyamatait, fájdalompontjait és céljait. Személyesen
                            vagy online.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Elkészítjük a rendszertervet és az árajánlatot. Ön dönt, mi haladunk.
                        </p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Agilis módszertannal dolgozunk: rendszeres demók, folyamatos
                            visszajelzés.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Billingo, Számlázz.hu, Kulcs-Soft és más magyar
                                    rendszerek</p>
                            </div>
                        </div>
                ...
                <div class="rounded-2xl bg-gray-50 p-8">
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/sap.svg') }}" alt="SAP"
                                class="h-9 w-auto">
                        </div>
                        {{-- Billingo --}}
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/billingo.svg') }}" alt="Billingo"
                                class="h-9 w-auto">
                        </div>
                        {{-- Shopify --}}
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/shopify.svg') }}" alt="Shopify"
                                class="h-7 w-auto">
                        </div>
                        {{-- Microsoft Teams --}}
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/teams.svg') }}"
                                alt="Microsoft Teams" class="h-10 w-auto">
                        </div>
                        {{-- Slack --}}
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/slack.svg') }}" alt="Slack"
                                class="h-8 w-auto">
                        </div>
                        {{-- Nexon --}}
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/nexon.svg') }}" alt="Nexon"
                                class="h-5 w-auto">
                        </div>
                        {{-- HubSpot --}}
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/hubspot.svg') }}" alt="HubSpot"
                                class="h-10 w-auto">
                        </div>
                        {{-- Microsoft Dynamics --}}
                        <div class="flex h-20 items-center justify-center rounded-xl bg-white p-4 shadow-sm">
                            <img src="{{ Vite::asset('resources/images/integrations/dynamics.svg') }}"
                                alt="Microsoft Dynamics 365" class="h-10 w-auto">
                        </div>
                ...
                <div class="rounded-2xl bg-gray-100 p-8">
                    ...
                    <p class="mt-6 text-sm text-gray-500">
                        ...
                        <a href="{{ route('solutions.kkv') }}"
                            class="font-medium text-indigo-600 hover:underline">KKV csomagunkat</a>
                        vagy az
                        <a href="{{ route('pricing') }}" class="font-medium text-indigo-600 hover:underline">árazási
                            oldalunkat</a>.
                    </p>
                </div>
            </div>
            ...
            <div class="mt-12 grid gap-8 lg:grid-cols-2">
                <div class="rounded-2xl bg-white p-8 shadow-sm">
                    ...
                    <blockquote class="mb-6 text-lg text-gray-700">
                        „Korábban 4 különböző rendszert használtunk, most minden egy helyen van. A Cégem360 csapata
                        pontosan megértette, mire van szükségünk."
                    </blockquote>
                ...
                <div class="rounded-2xl bg-white p-8 shadow-sm">
                    ...
                    <blockquote class="mb-6 text-lg text-gray-700">
                        „A bevezetés zökkenőmentes volt, és azóta is van kire számítani, ha kérdésem van. Ez az igazi
                        partnerség."
                    </blockquote>
                    <div class="flex items-center gap-4">
                        <div
            ...
            <div class="mx-auto mt-12 max-w-3xl space-y-4">
                <div x-data="{ open: false }" class="rounded-xl bg-gray-50 shadow-sm">
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-6">
                        <p class="text-gray-600">Bármilyen méretű cégnek, akinek egyedi igényei vannak. Dolgoztunk már
                            5 fős startuppal és 500 fős gyártó céggel is. A lényeg nem a méret, hanem hogy a standard
                            megoldások nem felelnek meg az igényeinek.</p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="rounded-xl bg-gray-50 shadow-sm">
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-6">
                        <p class="text-gray-600">A projekt komplexitásától függően 4-16 hét. Egy egyszerűbb integráció
                            akár 2 hét alatt is elkészülhet, míg egy teljes egyedi rendszer fejlesztése több hónapot is
                            igénybe vehet. A konzultáción pontosabb időbecslést adunk.</p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="rounded-xl bg-gray-50 shadow-sm">
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-6">
                        <p class="text-gray-600">Agilis módszertannal dolgozunk, ami azt jelenti, hogy rugalmasan
                            tudunk alkalmazkodni a változó igényekhez. Rendszeres demókon egyeztetünk, és szükség esetén
                            módosítjuk az irányt.</p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="rounded-xl bg-gray-50 shadow-sm">
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-6">
                        <p class="text-gray-600">Egyedi projekteknél Proof of Concept (PoC) fázist tudunk biztosítani,
                            ahol egy kisebb scope-on tesztelheti a megoldást, mielőtt a teljes projektre elköteleződne.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <p class="mb-10 text-lg text-indigo-100">
                    Egyeztessünk egy 30 perces hívást, ahol megértjük a kihívásait és felvázoljuk a lehetséges
                    megoldásokat.
