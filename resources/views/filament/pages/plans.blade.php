        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div class="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-start gap-3">
                    <div
                        class="flex size-9 shrink-0 items-center justify-center rounded-lg bg-primary-50 dark:bg-primary-500/10">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Szinkronizálja a helyi terveket a Stripe-pal. Termékeket és árakat hoz létre HUF és EUR
                            pénznemben.
                        </p>
                        <div class="mt-2 flex flex-wrap gap-1.5">
                            <span
                                class="inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-600 dark:bg-gray-700 dark:text-gray-300">--force</span>
                            <span
                                class="inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-600 dark:bg-gray-700 dark:text-gray-300">--dry-run</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-start gap-3">
                    <div
                        class="flex size-9 shrink-0 items-center justify-center rounded-lg bg-info-50 dark:bg-info-500/10">
                        <x-filament::icon icon="heroicon-o-command-line"
                            class="size-4 text-info-600 dark:text-info-400" />
                    </div>
                    <div>
                        ...
                        <div class="mt-2 flex flex-wrap gap-1.5">
                            <span
                                class="inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-600 dark:bg-gray-700 dark:text-gray-300">--subscription=ID</span>
                        </div>
                    </div>
                </div>
            </div>
