        ...
        <div class="flex min-h-screen">
            ...
            <div class="flex w-full flex-col bg-white lg:w-1/2">
                ...
                <div class="flex items-center justify-between px-6 py-6 lg:px-12">
                    <a href="{{ route('home') }}">
                        <img src="{{ Vite::asset('resources/images/cegem360-logo.png') }}"
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6">
                            ...
                            <div class="bg-white rounded-lg p-3 shadow-sm">
                                ...
                                <div class="flex gap-2">
                                    <div
                                        class="flex-1 bg-indigo-500 rounded h-6 flex items-center justify-center text-xs font-medium text-white">
                                        CRM</div>
                                    <div
                                        class="flex-1 bg-emerald-500 rounded h-6 flex items-center justify-center text-xs font-medium text-white">
                                        HR</div>
                                    <div
                                        class="flex-1 bg-amber-500 rounded h-6 flex items-center justify-center text-xs font-medium text-white">
                                        Finance</div>
                                    <div
                                        class="flex-1 bg-purple-500 rounded h-6 flex items-center justify-center text-xs font-medium text-white">
                                        +2</div>
                                </div>
                            </div>
                        </div>
